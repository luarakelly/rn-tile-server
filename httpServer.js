...
module.exports = {
    ...
    respondWithArray: (requestId, code, type, body) => Server.respondWithArray(requestId, code, type, body),

    respondWithString: (requestId, code, type, body) => Server.respondWithString(requestId, code, type, body)
}
